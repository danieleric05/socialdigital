          ...
          <div class="usr-pnl">
            ...
            <div class="pnl-bdy">
              <div class="usr-cnt">
                ...
                <div class="social-btns"> <span>Social Media:</span>
                  <ul>
                    <li><a href="#" title=""><i class="fa fa-facebook"></i></a></li>
                    <li><a href="#" title=""><i class="fa fa-twitter"></i></a></li>
                    <li><a href="#" title=""><i class="fa fa-google-plus"></i></a></li>
              ...
              <div class="usr-cnt">
                ...
                <div class="social-btns bg-scl"> <span>Social Media:</span>
                  <ul>
                    <li><a href="#" title=""><i class="fa fa-facebook"> Get Spotted</i></a></li>
                    <li><a href="#" title=""><i class="fa fa-twitter"> BSpotted777</i></a></li>
                    <li><a href="#" title=""><i class="fa fa-google-plus"> bspotted GmbH</i></a></li>
                    <li><a href="#" title=""><i class="fa fa-foursquare"> Foursquare</i></a></li>
                  </ul>
                </div>
              </div>
              <!-- Usr Connect --> 
