                  ...
                  <div class="chat-system-innr">
                    ...
                    <div class="cht-bdy">
                      <ul>
                        ...
                        <li class="chat-message me"> <span class="sndr-nm"><img src="images/resource/frnd-1.jpg" alt=""></span>
                          <div class="msg-bx">Hello</div>
                        </li>
                        <li class="chat-message me"> <span class="sndr-nm"><img src="images/resource/frnd-1.jpg" alt=""></span>
                      ...
                      <div class="comment-form">
                        <form>
                          ...
                          <a href="#" title=""><i class="flaticon-smile"></i></a>
                        </form>
                        <span> <i class="fa fa-paperclip"></i>
                        <label class="fileContainer"> Add Files
                          <input type="file"/>
                        </label>
                        </span> <span> <i class="fa fa-photo"></i>
                        <label class="fileContainer"> Add Photos
                          <input type="file"/>
                        </label>
                        </span> <a href="#" title="" class="purple-skin">Send</a> </div>
                    </div>
                  </div>
                </div>
                <!-- Chat Messages --> 
