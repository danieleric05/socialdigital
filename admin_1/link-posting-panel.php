...
<div class="popup-wrp2 lnk-pst-pnl"> <span class="pp-cls"></span>
  <div class="popup-innr">
    <div class="scrl">
      <div class="user-activity ad-pst ">
        <div class="who-post-this"> <span><img src="images/resource/user.jpg" alt="" /></span>
          <div class="who-post-detail">
            ...
            <a href="#" title="" class="lnk">https://themeforest.net/item/electric-admin-panel-dashboard-angular-js-template/14879635</a> <a href="#" title="" class="lnk">https://themeforest.net/item/kraft-simple-portfolio-wordpress-theme/17515270</a>
            <div class="ad-lnk">
              <form>
        ...
        <div class="post-content">
          <div class="pst-carousel">
            <div class="pst-frmt">
              <ul class="pst-edt-btns">
                <li><a class="dl-btn" href="#" title=""><i class="fa fa-trash"></i></a></li>
                <li>
                  <label class="fileContainer"> <i class="fa fa-pencil-square-o"></i>
                    <input id="upl1" type="file"/>
                  </label>
                </li>
              </ul>
              <a href="#" title=""><img id="upl-chng1" src="images/resource/pst-md-img1.jpg" alt="" /></a>
              <div class="pst-inf">
                <h2><a href="#" title="">Electric - Admin Panel Dashboard Angular JS Templete</a></h2>
                <span>themeforest.net</span> </div>
            </div>
            <div class="pst-frmt">
              <ul class="pst-edt-btns">
                ...
                <li>
                  <label class="fileContainer"> <i class="fa fa-pencil-square-o"></i>
                    <input id="upl2" type="file"/>
                  </label>
                </li>
              </ul>
              <a href="#" title=""><img id="upl-chng2" src="images/resource/pst-md-img2.jpg" alt="" /></a>
              <div class="pst-inf">
                <h2><a href="#" title="">Kraft - Simple Prtfolio WordPress Theme</a></h2>
                <span>themeforest.net</span> </div>
            </div>
            <div class="pst-frmt">
              <ul class="pst-edt-btns">
                ...
                <li>
                  <label class="fileContainer"> <i class="fa fa-pencil-square-o"></i>
                    <input id="upl3" type="file"/>
                  </label>
                </li>
              </ul>
              <a href="#" title=""><img id="upl-chng3" src="images/resource/pst-md-img3.jpg" alt="" /></a>
              <div class="pst-inf">
                <h2><a href="#" title="">PicStock- Ultra Advanced Stock Media php Template</a></h2>
                <span>themeforest.net</span> </div>
            </div>
      ...
      <div class="add-content">
        ...
        <a href="post-preview-page.php" title="" class="purple-skin">Preview</a> </div>
    </div>
  </div>
</div>
