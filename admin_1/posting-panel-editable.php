  ...
  <div class="popup-innr">
    <div class="scrl">
      <div class="user-activity ad-pst ">
        <div class="who-post-this"> <span><img src="images/resource/user.jpg" alt="" /></span>
          <div class="who-post-detail">
            <textarea>Freebie this time is another PSD file. I was inspired by the metro concept adapted by the microsoft . It was elegant,  clean, minimal ,intuitive and free from clutter. I happen to notice many designs based on this concept and wanted to do something for WordPress similarly.  So there it is , a twitter widget PSD. It very simple design and I hope I did justice to the metro ui concept on this design.  One can use this design while developing a custom twitter widget for wordpress.</textarea>
            <div class="ad-lnk">
              <form>
        ...
        <div class="add-img mrg10 row"> <strong>Suggested Photos</strong>
          <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-6">
