            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="g-map">
                        <div class="mapouter">
                            <div class="gmap_canvas">
                                <iframe width="600" height="500" id="gmap_canvas"
                                    src="https://maps.google.com/maps?q=24%20rue%20Albert%201er,%2094600%20CHOISY%20LE%20ROI&t=&z=13&ie=UTF8&iwloc=&output=embed"
                        ...
                        <div class="map-meta">
                            <h1>get in touch</h1>
                            <p>MyInfluencersSoftware helps you improve modern customer experience management through
                                care, research, engagement, advertising, and marketing.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="contact-form">
                            ...
                            <form method="post">
                                ...
                                <div class="submit-btns">
                                    <button class="mtr-btn signup" type="button"><i
                        ...
                        <div class="cntct-adres">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <span>24 rue Albert 1er, 94600 CHOISY LE ROI.</span>
                                </li>
                                <li>
                                    <i class="fa fa-mobile-phone"></i>
                                    <span>+336 66-95-00-00</span>
                                </li>
                                <li>
                                    <i class="fa fa-envelope-o"></i>
                                    <span>info@myinfluencerssoftware.com</span>
                                </li>
                            </ul>
                            ...
                            <h1 class="bg-cntct">SOCIAL DIGITAL</h1>
                        </div>
                    </div>
                </div>
            </div>
