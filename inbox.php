                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-4">
                                        <div class="inbox-navigation">
                                            <div class="inbox-panel-head">
                                                ...
                                                <a title="" href="edit-profile-basic.php"><i
                                                        class="fa fa-user"></i>Profile</a>
                                                <a title="" href="edit-account-setting.php"><i
                                            ...
                                            <ul>
                                                <li class="active"><a title=""><i
                                                            class="fa fa-inbox"></i>Inbox</a><span>4</span></li>
                                            ...
                                            <div class="flaged">
                                                ...
                                                <ul>
                                                    <li><a title="" href="#"><i style="color:#ff5c5c;"
                                                                class="fa fa-tag"></i>Family</a></li>
                                                    <li><a title="" href="#"><i style="color:#3ac1e3;"
                                                                class="fa fa-tag"></i>Friends</a></li>
                                                    <li><a title="" href="#"><i style="color:#f3d547;"
                                                                class="fa fa-tag"></i>Private</a></li>
                                                    <li><a title="" href="#"><i style="color:#b447f3;"
                                        ...
                                        <div class="inbox-lists">
                                            <div class="inbox-action">
                                                <ul>
                                                    ...
                                                    <li><a class="delete-email" title=""><i class="fa fa-trash-o"></i>
                                                            Delete</a></li>
                                            ...
                                            <div class="mesages-lists">
                                                ...
                                                <ul id="message-list" class="message-list">
                                                    ...
                                                    <li class="unread">
                                                        ...
                                                        <p>That a reader will be distracted by the readable content..
                                                        </p>
                                                    </li>
                                                    <li class="read">
                                                        <input class="select-message" type="checkbox" />
