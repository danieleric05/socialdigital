				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-heading">
							<h2>Pricing</h2>
							<p>Our affordable pricing for your potential customers with this SOCIAL DIGITAL example. it's build with bootstrap 4 component and utilities with little customisation</p>
						</div>
					</div>
