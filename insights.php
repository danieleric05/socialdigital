                    ...
                    <div class="row merged20" id="page-contents">
                        <div class="col-lg-3">
                            <aside class="sidebar static">
                                <div class="widget">
                                    <h4 class="widget-title">Linkedin feed</h4>
                                    <ul class="twiter-feed">
                                        <li>
                                            <i class="fa fa-twitter"></i>
                                            <span>
                                                <i>Rachelle Trombière</i>
                                                @jhonwilliam
                                            </span>
                        ...
                        <div class="col-lg-6">
                            <div class="central-meta">
                                <div class="messages">
                                    <h5 class="f-title"><i class="fa fa-line-chart"></i>Statistics <span
                                            class="more-options"><i class="fa fa-ellipsis-h"></i></span></h5>
                                    <div class="insight-box">
                                        <div class="x_panel">
                                            <div class="x_title">
                                                <h2>Likes Linkedin</h2>
                                            </div>
                                            <ul class="toolbox">
