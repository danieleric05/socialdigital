                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-8">
                                <div class="tutorial-video">
                                    ...
                                    <iframe width="560" height="350" src="https://www.youtube.com/embed/r0uiE3gg97A"
                                        frameborder="0"
                            ...
                            <div class="col-lg-5 col-md-4">
                                <div class="vid-links">
                                    ...
                                    <ul class="tutor-links">
                                        <li><a href="#" title=""><i class="fa fa-play-circle-o"></i> useful video</a>
                                        </li>
                                        <li><a href="#" title=""><i class="fa fa-play-circle-o"></i> how to start</a>
                                        </li>
                                        <li><a href="#" title=""><i class="fa fa-play-circle-o"></i> theme
                                                installation</a></li>
                                        <li><a href="#" title=""><i class="fa fa-play-circle-o"></i> warnings</a></li>
                                        <li><a href="#" title=""><i class="fa fa-play-circle-o"></i> configurations</a>
                                        </li>
                                        <li><a href="#" title=""><i class="fa fa-play-circle-o"></i> total videos</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
