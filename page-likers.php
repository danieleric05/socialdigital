                                ...
                                <div class="frnds">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item"><a class="active" href="#frends"
                                                data-toggle="tab">Likers</a> <span>55</span></li>
                                        <li class="nav-item"><a class="" href="#frends-req"
                                                data-toggle="tab">Follwers</a><span>60</span></li>
                                    </ul>
                                            ...
                                            <ul class="nearby-contct">
                                                <li>
                                                    <div class="nearly-pepls">
                                                        <figure>
                                                            <a href="time-line.php" title=""><img
                                                        ...
                                                        <div class="pepl-info">
                                                            ...
                                                            <span>ftv model</span>
                                                            <a href="time-line.php" title="" class="add-butn"
