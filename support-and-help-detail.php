            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="help-list">
                        ...
                        <ul>
                            ...
                            <li><a title="" href="#"><i class="ti-direction"></i>Inviting friends to join SOCIAL
                                    DIGITAL</a></li>
                            <li><a title="" href="#"><i class="ti-direction"></i>How do I search for my friends?</a>
                            </li>
                            ...
                            <li><a title="" href="#"><i class="ti-direction"></i>may i live chat with SOCIAL
                                    DIGITAL?</a></li>
                            <li><a title="" href="#"><i class="ti-direction"></i>how to join group and list of
                                    group?</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="help-topic">
                        <h2>How do i post video on SOCIAL DIGITAL?</h2>
