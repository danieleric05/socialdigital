                ...
                <div class="col-lg-3">
                    <aside class="sidebar static">
                        <div class="widget">
                            ...
                            <ul class="socials">
                                <li class="linkedin">
                                    <a title="" href="#"><i class="fa fa-linkedin"></i> <span>linkedin</span> <ins>45
                                            likes</ins></a>
                                </li>
                                <li class="twitter">
                                ...
                                <li class="instagram">
                                    <a title="" href="#"><i class="fa fa-instagram"></i> <span>instagram</span> <ins>45
                                            likes</ins></a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-6">
                                <div class="help-list">
                                    ...
                                    <ul>
                                        <li><a href="support-and-help-detail.php" title=""><i
                                                    class="ti-direction"></i>How to Create your account</a></li>
                                        <li><a href="support-and-help-detail.php" title=""><i
                                                    class="ti-direction"></i>post video on my account?</a></li>
                                        <li><a href="support-and-help-detail.php" title=""><i
                                                    class="ti-direction"></i>Inviting friends to join SOCIAL DIGITAL</a>
                                        </li>
                                        <li><a href="support-and-help-detail.php" title=""><i
                                                    class="ti-direction"></i>How do I search for my friends?</a></li>
                                        <li><a href="support-and-help-detail.php" title=""><i
                                                    class="ti-direction"></i>Create and manage groups</a></li>
                                    </ul>
