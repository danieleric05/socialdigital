                        ...
                        <div class="col-lg-3">
                            <aside class="sidebar static">
                                <div class="widget">
                                    ...
                                    <ul class="socials">
                                        <li class="linkedin">
                                            <a title="" href="insights.php"><i class="fa fa-linkedin"></i>
                                                <span>linkedin</span> <ins>45 likes</ins></a>
                                        </li>
                                        <li class="twitter">
                                            <a title="" href="insights.php"><i class="fa fa-twitter"></i>
                                                <span>twitter</span><ins>25 likes</ins></a>
                                        </li>
                                        <li class="instagram">
                                            <a title="" href="insights.php"><i class="fa fa-instagram"></i>
                                                <span>instagram</span> <ins>45 likes</ins></a>
                                        </li>
                                    </ul>
                                </div>
                                <!--<div class="widget">
                                ...
                                <div class="widget">
                                    ...
                                    <ul class="activitiez">
                                        ...
                                        <li>
                                            <div class="activity-meta">
                                                <i>30 Days Ago</i>
                                                <span><a href="newsfeed.php" title="">Posted your status. “Hello guys,
                                                        how are you?”</a></span>
                                            </div>
                                        </li>
                                        <li>
